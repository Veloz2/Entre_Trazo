...
### Descripción
Este repositorio contiene la solución para el sistema web de cotizaciones y citas de Entre Trazo. Su propósito es permitir a los clientes solicitar cotizaciones y agendar citas de forma eficiente, y al administrador gestionar y dar seguimiento a cada solicitud desde un panel privado.
